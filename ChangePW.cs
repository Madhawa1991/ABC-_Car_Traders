...
namespace ABC_Car_Traders
{
    public partial class ChangePW : Form
    {
        ...
        {
            {
                // null  values in username, teliphone, NIC fields
                ...
                {
                    MessageBox.Show("Please enter your Teliphone.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                ...
                try
                {
                    using (SqlConnection con = new SqlConnection("Data Source=DESKTOP-M9JEPR6\\VS_SERVER;Initial Catalog=\"ABC Car Traders\";Integrated Security=True;TrustServerCertificate=True"))
                    {
                        ...
                        if (count > 0)
                        {
                            ...
                            cmd.Parameters.AddWithValue("@password", EncryptPassword(ChangePWReNewPW.Text)); // Use the hashed password
